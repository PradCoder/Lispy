...
This file contains the basis of the Lispy programming language
though slightly modified from Daniel Holden's implementation

This is pretty much the basis of the language I've made 
the functionality and implementation shall be modified iteratively
*/
